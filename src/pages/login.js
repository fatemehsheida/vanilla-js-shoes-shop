...
export default function login() {
  const login = ce("div", {
    ...
    children: [
        ...
        children: [
          ...
          ce("div", {
            ...
            children: [
              ce("div", {
                className:
                  "w-full h-[37px] flex flex-row justify-center items-center bg-[#FAFAFA]",
                children: [
                  ce("i", {
                    className:
                      " w-1/12 fa-solid fa-envelope text-slate-500 flex items-center justify-center pl-3 ",
                  }),
                  ce("input", {
                    className:
                      "w-11/12 h-9 py-2.5 placeholder:text-slate-500 focus:border-pink-500 bg-[#FAFAFA]",
              ...
              ce("div", {
                ...
                children: [
                  ce("i", {
                    className:
                      " w-1/12 fa-solid fa-lock text-slate-500 flex items-center justify-center pl-3 ",
                  }),
                  ce("input", {
                    className:
                      "w-11/12  h-9 py-2.5 placeholder:text-slate-500 focus:border-pink-500 bg-[#FAFAFA]",
          ...
          ce("div", {
            className:
              "w-full h-12 flex flex-row justify-center items-center gap-2 mt-10",
            children: [
              ce("input", {
                restAttrs: {
                  type: "checkbox",
      ...
      ce("div", {
        className:
          "w-full h-1/6  flex flex-col justify-end items-center px-6 pb-8 cursor-pointer",
        children: [
          ce("button", {
            className:
